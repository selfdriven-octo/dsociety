            ...
            if (wallets.length == 0)
            {
                ...
                [
                    '<div class="mt-6">',
                        ...
                        '<div class="mt-4"><a href="https://www.cardanocube.io/collections/wallets" target="_blank" style="font-size:1.2rem;">Cardano Wallets <i class="fe fe-external-link"></a></div>',
                    '</div>'
                ]);
