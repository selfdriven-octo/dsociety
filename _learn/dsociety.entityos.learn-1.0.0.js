		...
		code: function (param)
		{
            ...
            window.cardano[walletName].enable().then(function (wallet)
            {
                ...
                wallet.getBalance().then(function(dataAsCBORHex)
                {
					...
					[
						'<div style="background-color:rgba(0,0,0,0.5); border-radius: 6px; padding:16px;" class="mx-auto w-md-25 mt-6">',
							'<div style="font-family: PT Mono, monospace; font-size: 1.65rem; color:#795548;" class="fw-bold text-center mb-1">',
					...
					_.each(_otherAssets, function (_otherAssetValue, _otherAssetKey)
					{
						learnWalletAssetsView.add(
						[
							'<div style="font-family: PT Mono, monospace; font-size: 1rem; color:#795548;" class="text-center">',
