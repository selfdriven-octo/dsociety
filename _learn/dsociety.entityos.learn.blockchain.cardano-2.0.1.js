...
[
	...
	},
	{
		...
		code: function ()
		{
			...
			else
			{
				...
				$('#learn-view').html('<div class="mt-6" style="font-size: 1.2rem;"><div class="fw-bold text-secondary">Please connect to a wallet to continue.</div><div class="mt-2 text-secondary">Thank you, Turlia.</a>');
			}
		}
	},
	{
	...
	},
	{
		...
		code: function (param)
		{
			// Other functions - starting with sign data

			var learnWalletView = eos.view();

			learnWalletView.add(
			[
				'<div class="card w-md-50 mt-6 shadow-lg border border-secondaey">',
					'<div class="card-body p-4">',
						'<div class="form-group">',
							'<div class="mb-2"><label class="fw-bold text-secondary" for="url-text">Enter Data to Sign</label>',
							'</div>',
							'<textarea id="url-text" class="form-control entityos-text w-100" style="height:180px;" data-scope="learn-cardano-wallet" data-context="sign-data-text"></textarea>',
						'</div>',
