...
[
	...
	},
	{
		...
		code: function ()
		{
			//https://chatgpt.com/c/325f268f-15ee-43d7-9564-b58c0943b11c
	...
	{
		name: 'learn-ssi-hex-to-array',
		code: function (dataHex)
		{
			if (dataHex.length % 2 !== 0) throw new Error("Invalid hex string");
	...
	},
    {
		...
		code: function (data)
		{
			...
			//Test: https://appdevtools.com/base58-encoder-decoder

			const dataArray = eos.invoke('learn-ssi-hex-to-array', data)
